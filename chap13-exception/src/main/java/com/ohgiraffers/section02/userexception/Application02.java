...
public class Application02 {
    ...
    public static void main(String[] args){
        ...
        * 그렇기 때문에 항상 Scanner.close()를 호출하여 리소스를 제거해 줘야 한다.
        * */
        ...
        try {
            ...
            System.out.println("가진 돈을 입력해 주세요!");
            int money = sc.nextInt();
                ...
                // finally블럭은 오류가 있던 없던 항상 실해하는 블럭이다.
            /*
            * 위에 설명한 내용과 같이 Scanner는 리소스를 사용하면 닫아주어야 한다.
            * 그렇기 때문에 try블러에서 닫는 경우 에러가 발생되었을때 닫히지 않는 경우가 발생할 수 있어
            * finally 블럭에서 ㄹSCANNER에 할당된 리소스를 제거하여 오류가 발생하던 발생하지 않던 리소스를 제거하게 된다.
            * */
                sc.close();
                System.out.println("오류가 나던말던 나는 나의 길을 간다.");
            }
...
//        sc.nextLine();
        ...
        * 이를 축약한 확장 문법으로 try블럭에 ()소괄호 부분에 리소스 할당이 필요한 인스턴스를 생성하게 된다면
