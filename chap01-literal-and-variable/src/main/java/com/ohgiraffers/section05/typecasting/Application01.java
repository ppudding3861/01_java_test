...
public class Application01 {
    ...
    public static void main(String[] args){
        ...
        * */
        ...
        byte bnum = 1;
            ...
            /*
            * 설명. 연산시에도 자동으로 큰 쪽 자료형에 맞춰서 계산한다
            * */
            int num1 = 10;
            long num2 = 20;
    ...
    * */
    ...
    //long eight = 88888888888888888888
        //이것도 자동으로 형변환 된 것이다.(int 범위 벗어나면 에러 발생)
    ...
    /*
    * 설명.
    * 따라서 실수와 정수의 연산은 실수로 연산결과가 반환된다.
    * */
    ...
    * */
    ...
    /*
    * 설명.
    * int로 type이 정해지지 않은 리터럴 형태의 정수는 char형 변수에 기록가능하다.
    * */
