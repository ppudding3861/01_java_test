...
public class Application01 {
    public static void main(String[] args){
        ...
        * 2. 키는 중복을 혀용하지 않지만, 키가 다르면 중복되는 값은 저장할 수 있다.
        *
        * hashMap, hashTable, treeMap 등의 대표적인 클래스가 있다
        * hashMap이 가장 많이 사용되며 HashTable은 jdk1.0부터 제공되며
        * HashMap과 동일하게 동작한다. 하위 호환을 위해 남겨놓았기 때 문에 가급적이면 hashMap을 사용하는 것이 좋다.
        * */

        //hashMap jdk1.2 부터 제공되는 클래스로 해시 알고리즘을 사용하여 검색속도가 매우 빠르다.
